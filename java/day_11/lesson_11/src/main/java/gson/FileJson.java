...
//                // Và trả về kết quả
//                reader.close();
//                return student; // return student thì phải tạo biến hứng kết quả
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//
...
////    public static void convertObjectToJsonFile(String fileName, Object obj) {// kiểu dữ liệu object là cha của tất cả các con
////        try {
////            // Tạo đối tượng gson
////            // Gson gson = new Gson();
////
