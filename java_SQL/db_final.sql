...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2023 at 04:06 AM
...
INSERT INTO `cv_detail` (`id`, `cv_id`, `user_id`, `content`) VALUES
(1, 1, 2, 'https://www.topcv.vn/images/cv/screenshots/vi/passion.png'),
(2, 2, 9, 'https://www.topcv.vn/images/cv/screenshots/vi/ambitious.png'),
(3, 4, 10, 'https://www.topcv.vn/images/cv/screenshots/vi/passion.png'),
(4, 10, 11, 'https://www.topcv.vn/images/cv/screenshots/vi/basic_3_v2.png'),
(5, 9, 12, 'https://www.topcv.vn/images/cv/screenshots/vi/default_v2.png'),
(6, 8, 13, 'https://www.topcv.vn/images/cv/screenshots/vi/time.png'),
(7, 5, 14, 'https://www.topcv.vn/images/cv/screenshots/vi/experts.png');
...
--
-- Dumping data for table `employer_detail`
--

INSERT INTO `employer_detail` (`id`, `employer_id`, `address`, `recruitment`, `image`, `workday`) VALUES
(1, 1, '82/15 Đường số 2, Khu phố 6, Phường Hiệp Bình Phước, Thành phố Thủ Đức, Thành phố Hồ Chí Minh', 'Nhân Viên Thiết Kế - Chế Bản In Ấn', NULL, 'từ thứ 2 - thứ 6 và sáng thứ 7\r\n\r\n'),
(2, 2, 'Tòa Nhà Bảo Hân - P302, Số 66, Ngõ 34, Hoàng Cầu, Đống Đa, Hà Nội', 'Nhân Viên Kinh Doanh / Tư Vấn/ Sale Tại Hà Nội', NULL, 'Giờ hành chính, nghỉ chiều thứ 7 và ngày chủ nhật.'),
(3, 3, '- Hà Nội: 98-100 Khương Đình, Phường Hạ Đình, Thanh Xuân\r\n- Nghệ An: 42 Mai Hắc Đế, TP Vinh\r\n- Hồ Chí Minh: Số 3 Trần Nhân Tôn, Phường 9, Quận 5', 'Nhân Viên Kinh Doanh ', NULL, ':Từ 8h – 12h và từ 13h00 – 17h00 Từ thứ 2 – thứ 6 và sáng thứ 7'),
(4, 4, 'Số 61, phố Trần Phú, Phường Điện Biên, Quận Ba Đình, Thành phố Hà Nội, Việt Nam', 'Nhân Viên Hành Chính Lễ Tân', NULL, 'Làm việc thứ 2 đến thứ 6 , nghỉ thứ 7 và chủ nhật'),
(5, 5, '265 Hồng Lạc, Phường 10, Quận Tân Bình, Thành phố Hồ Chí Minh, Việt Nam', 'Quản Trị Hệ Thống Junior ', NULL, 'Theo ca được phân công (Ngày 3 ca làm việc: 8h00 - 16h00 , 16h00 - 0h00 và 0h00 - 8h00).'),
(6, 6, 'Hồ Chí Minh: Số 34 Tiền Giang, Phường 2, Tân Bình', 'Nhân Viên Lễ Tân Hành Chính', NULL, ' Thứ 2 đến thứ 7, từ 8h30 -> 17h30, trưa nghĩ 1h30\" .');
...
CREATE TABLE `evaluate` (
  ...
  `needToIprove` varchar(255) DEFAULT NULL,
...
INSERT INTO `evaluate` (`id`, `user_id`, `employer_id`, `title`, `strength`, `weakness`, `needToIprove`, `overallRating`, `created_at`, `deleted_at`, `updated_ad`) VALUES
(1, 2, 1, 'Công ty không nên làm việc', 'Không có điểm mạnh ', 'Công ty đã lương thấp lại còn áp lực, sếp thì yêu cầu 1 đống việc nhưng chỉ trả có vài đồng bạc. Khuyên mọi người không nên làm ở đây', 'Công ty cần trả lương cao hơn đối với những áp lực, yêu cầu từ ban lãnh đạo', '0.5☆', '2023-03-08 06:23:30', NULL, NULL),
(2, 9, 2, 'Đoàn kết là sức mạnh', 'Công ty có đội ngũ nhân viên nhiệt tình, chế độ lương thưởng hấp dẫn.\r\nCông ty có nhiều hoạt động ngoại khóa để kết nối nhân viên \r\nĐặc biệt với dàn nhân viên trẻ trung sẽ là điểm đến tuyệt vời dành cho các bạn trẻ trung và năng động\r\nHãy cùng tôi trải ng', 'Có lẽ điểm yếu duy nhất chính Đức Việt chưa thể tạo ra nhiều nhiều hơn môi trường làm việc hơn cho các bạn.', NULL, '5☆', '2023-02-07 03:47:13', NULL, '0000-00-00 00:00:00'),
(3, 10, 3, 'Vietmap - đưa cả thế giới lại gần với bạn', 'Môi trường làm việc chuyên nghiệp, nhiều cơ hội thăng tiến.\r\nCác bạn nhân viên rất nhiệt tình và năng động\r\nChế độ lương thưởng rất hấp dẫn.', 'Còn tồn đọng 1 vài cách giao tiếp chưa chuẩn chỉnh', 'Cần đạo tạo lại nhân viên có thái độ làm việc tốt hơn đối với khách hàng cũng như trong nội bộ công ty', '4☆', '2022-11-09 04:20:44', NULL, '0000-00-00 00:00:00'),
(4, 11, 4, 'chế độ đãi ngộ thấp', 'có đầy đủ phúc lợi', 'chế độ đãi ngộ thấp, đặc biệt là tiền xăng xe có 800k. không đủ nửa tiền xăng đi lại hàng tháng', 'Cần xem xét lại chế độ đãi ngộ cho hợp lý', '3☆', '2022-07-13 04:24:30', '2023-03-06 01:31:44', '2023-01-17 01:20:35'),
(5, 12, 5, 'Không nên làm việc tại công ty này', NULL, 'chế độ đãi ngộ thấp, chế độ lương thưởng thấp, yêu cầu với nhân viên nhiều, thời gian thử việc lâu', 'cần giải tán công ty', '0☆', '2022-12-13 03:47:19', NULL, NULL),
(6, 14, 6, 'Lương quá thấp', NULL, 'Chế độ lương quá thấp, lại yêu cầu cao hơn 1m6, lại còn cần ngoại hình ưa nhìn.\r\nThà làm phụ hồ còn lương cao hơn.\r\n', 'không cần cải thiện gì đâu, cứ vậy đi, đừng ai nộp hồ sơ vào công ty này', '4☆', '2022-11-12 07:16:36', NULL, '2023-03-04 23:30:25');
...
CREATE TABLE `recruitment_details` (
  ...
  `candidateRequirement` text DEFAULT NULL,
...
INSERT INTO `user` (`id`, `email`, `password`, `role`, `avatar`) VALUES
(1, 'admin@gmail.com', 'khongcopass', 'admin', 'https://taimienphi.vn/tmp/cf/aut/Uhun-IbFB-MnGE-DiPL-OCTB-hinh-dep-1.jpg'),
(2, 'kien@gmail.com', 'kiendeptrai', 'user', 'https://scontent.fhan5-10.fna.fbcdn.net/v/t1.6435-9/58444940_1775696015864170_2529676393780871168_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=174925&_nc_ohc=lcKodOY-U2wAX_ongrV&_nc_ht=scontent.fhan5-10.fna&oh=00_AfBG-QC10qOKyrxevIyVDEQz4oh0ZDXPYo5AO9OVu9AQNQ&oe=644'),
(3, 'hoasen@gmail.com', 'congtyhoasen1', 'employer', 'https://cdn.topcv.vn/140/company_logos/daNjIByggsARn4D7oXqr0C6v3zlGrBVK_1632710437____3df8143efd7e44d1735add6f3c10c44e.PNG'),
(4, 'ducviet@gmail.com', 'congtyducviet2', 'employer', 'https://cdn.topcv.vn/80/company_logos/cong-ty-co-phan-tu-van-bat-dong-san-duc-viet-641c17766152b.jpg'),
(5, 'vietmap@gmail.com', 'congtyvietmap3', 'employer', 'https://cdn.topcv.vn/80/company_logos/cong-ty-co-phan-vietmap-ha-noi-6417b9abae45b.jpg'),
(6, 'buudien@gmail.com', 'congtyhanhchinhbuudien4', 'employer', 'https://www.topcv.vn/v4/image/topcv-logo-company-default.png'),
(7, 'vietnix@gmail.com', 'congtyvietnix5', 'employer', 'https://cdn.topcv.vn/80/company_logos/cong-ty-co-phan-giai-phap-va-cong-nghe-vietnix-624e5b3f74427.jpg'),
(8, 'locphuc@gmail.com', 'congtylocphuc6', 'employer', 'https://cdn.topcv.vn/80/company_logos/gD9IypiWPjQCwdbqhrljaAX1LL1krhFW_1657848066____b9674b0097c1a290982e22a07d0f3342.jpg'),
(9, 'taidao@gmail.com', 'taideptrai', 'user', 'https://media.techmaster.vn/api/static/kSEHy2fm/8luVYBrH'),
(10, 'xuananh@gmail.com\r\n', 'xuananhdeptrai', 'user', 'https://media.techmaster.vn/api/static/CMLEhVsl/z1v4W4xS'),
(11, 'trong@gmail.com', 'trongdeptrai', 'user', NULL),
(12, 'thangdz@gmail.com', 'thangdeptrai', 'user', NULL),
(13, 'toandz@gmail.com', 'toandeptrai', 'user', NULL),
(14, 'locphuho@gmail.com', 'locphuhodeptraitainang', 'user', NULL);
...
ALTER TABLE `cv_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cv_detail_cv` (`cv_id`),
  ADD KEY `fk_cv_detail_user` (`user_id`);
...
--
-- Indexes for table `employer_detail`
--
ALTER TABLE `employer_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_employer_detail_employer` (`employer_id`);
...
ALTER TABLE `evaluate`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_evalate_employer` (`employer_id`),
  ADD KEY `fk_evalate_user` (`user_id`);
...
ALTER TABLE `recruitment_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_recruitment_details_employer` (`employer_id`);
...
--
-- AUTO_INCREMENT for table `employer_detail`
--
ALTER TABLE `employer_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `cv_detail`
  ADD CONSTRAINT `fk_cv_detail_cv` FOREIGN KEY (`cv_id`) REFERENCES `cv` (`id`),
  ADD CONSTRAINT `fk_cv_detail_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `employer`
--
ALTER TABLE `employer`
  ADD CONSTRAINT `fk_employer_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `employer_detail`
--
ALTER TABLE `employer_detail`
  ADD CONSTRAINT `fk_employer_detail_employer` FOREIGN KEY (`employer_id`) REFERENCES `employer` (`id`);

--
-- Constraints for table `evaluate`
--
ALTER TABLE `evaluate`
  ADD CONSTRAINT `fk_evalate_employer` FOREIGN KEY (`employer_id`) REFERENCES `employer` (`id`),
  ADD CONSTRAINT `fk_evalate_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `recruitment_details`
--
ALTER TABLE `recruitment_details`
  ADD CONSTRAINT `fk_recruitment_details_employer` FOREIGN KEY (`employer_id`) REFERENCES `employer` (`id`);
COMMIT;
