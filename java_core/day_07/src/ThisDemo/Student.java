...
public class Student {
    ...
    public Student() {// constuctor không tham số
    }
    ...
    // this trong phương thức của lớp hiện tại
    public void methodOne(){
        System.out.println("one");
    }
    public void methodTwo(){
        methodOne();// cách 1
        this.methodOne();// cách 2
        System.out.println("two");
    }

    // trả về đối tượng của lớp hhienj tại
    public Student setAge(){
        this.age = 20;
        return this;// return đối tượng student
    }
